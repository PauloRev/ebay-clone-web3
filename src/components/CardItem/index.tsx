...
export default function CardItem({ listing }: CardProps) {
  return (
    <Link href={`/listing/${listing.id}`} className="flex flex-col card hover:scale-105 transition-all duration-150 ease-out">
      <div>
